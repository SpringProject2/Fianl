	...
	<div class="container">
		...
		<section class="right-section">
			...
			<div class="tabs">
				<form>
					<div class="tab-btns">
						Idx : <input id="idx" name="idx" type="hidden" value="${ signVo.idx }" readonly>
						SessionIdx : <input id="sessionIdx" name="sessionIdx" type="hidden" value="${ sessionUser.idx }" readonly>
